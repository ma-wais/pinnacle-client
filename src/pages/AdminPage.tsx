                        ...
                        <td className="py-16 text-end">
                          <div className="flex-align gap-8 justify-content-end">
                            ...
                            <button
                              ...
                              className="text-sm btn btn-outline-danger rounded-circle w-32 h-32 flex-center p-0"
                              title="Delete User"
                            >
                        ...
                        >
                          ...
                          <div className="d-flex gap-8 mt-12 pt-12 border-top border-neutral-30">
                            <button
                              ...
                              className="btn btn-sm btn-outline-success flex-grow-1 rounded-pill py-6 text-xs"
                              style={{
